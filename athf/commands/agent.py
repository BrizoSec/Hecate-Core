...
def run(  # noqa: C901
    ...
    if agent_name == "hypothesis-generator":
        ...
        try:
            ...
            console.print(r"  pip install 'athf\[litellm]'   # All providers via LiteLLM")
            console.print(r"  pip install 'athf\[openai]'    # OpenAI/GPT")
            console.print(r"  pip install 'athf\[bedrock]'   # AWS Bedrock")
            raise click.Abort()
        except Exception as e:
