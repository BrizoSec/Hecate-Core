...
from hecate_agent.core.hunt_manager import get_hunt_directory
...
def register_hunt_tools(mcp: "FastMCP") -> None:  # type: ignore[name-defined]  # noqa: F821, C901
    """Register all hunt-related MCP tools."""

    @mcp.tool(
        name="hecate_hunt_list",
        description=(
