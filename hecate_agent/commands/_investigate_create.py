...
from hecate_agent.core.investigation_parser import get_next_investigation_id
...
@click.option("--investigator", help="Investigator name", default="Hecate")
...
def new(
    ...
    Interactive mode (default):
      ...
      Example: hecate-agent investigate new

    \b
    Non-interactive mode:
      Provide all details via options for scripting.
      Example: hecate-agent investigate new --title "Alert Triage" \\
    ...
    After creation:
      ...
      3. Optionally promote to hunt: hecate-agent investigate promote I-XXXX
    """
    ...
    investigation_content = _render_investigation_template(
        investigation_id=investigation_id,
        title=inv_title,
        investigator=investigator or "Hecate",
    ...
    console.print("  3. View all investigations: [cyan]hecate-agent investigate list[/cyan]")
    console.print(f"  4. Promote to hunt if valuable: [cyan]hecate-agent investigate promote {investigation_id}[/cyan]")
