...
from hecate_agent.core.investigation_parser import get_all_investigations, validate_investigation_file
...
def list_investigations(
    ...
    if not investigations:
        ...
        console.print("\nCreate your first investigation: [cyan]hecate-agent investigate new[/cyan]")
        return
